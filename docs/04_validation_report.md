...
| Metrica | PM2.5 | PM10 |
|---------|-------|------|
| R² (LOOCV) | 0.6035 | 0.4138 |
| RMSE (µg/m³) | 1.8038 | 3.9229 |
| MAE (µg/m³) | 1.4994 | 3.1901 |
| MAPE (%) | 20.78 | 20.66 |
...
- `f008d1cbc5dc`: residuo = +3.621 µg/m³

**PM10** (umbral = 7.846 µg/m³):
...
|--------|---------|----------------|
| PM2.5 | 0.0163 | Heterocedasticidad detectada (p <= 0.05) |
...
|--------|---|---------|----------------|
| PM2.5 | 0.9727 | 0.8107 | Residuos normales (p > 0.05) |
| PM10  | 0.9823 | 0.9603 | Residuos normales (p > 0.05) |

### 3.3 Moran's I (autocorrelacion espacial)

| Target | I | E[I] | z | p-value | Interpretacion |
|--------|---|------|---|---------|----------------|
| PM2.5 | -0.0517 | -0.0526 | 0.015 | 0.9878 | Sin autocorrelación espacial (p > 0.05) |
...
- PM2.5 Ridge LOOCV: R²=0.604, RMSE=1.80 µg/m³, MAE=1.50 µg/m³.
